...
module.exports = async (d) => {
    ...
    let [varname, value, messageID = d.message?.id, table = d.client.mysql.tables[0]] = data.inside.splits;
    ...
    try {
        await d.client.mysql.set(table, varname?.addBrackets(), messageID, value);
    }
    catch (e) {
