...
module.exports = async (d) => {
    ...
    if (!name)
        return d.aoiError.fnError(d, "custom", { inside: data.inside }, "Invalid Channel Name Provided In");
    ...
    if (channel) {
        await d.client.mysql.set("__aoijs_vars__", "ticketChannel", channel.id, channel.id);
