...
module.exports = async (d) => {
    ...
    let [varname, value, userID = d.author?.id, Id = d.guild?.id || "dm", table = d.client.mysql.tables[0],] = data.inside.splits;
    ...
    try {
        await d.client.mysql.set(table, varname?.addBrackets(), `${userID}_${Id}`, value);
    }
    catch (e) {
