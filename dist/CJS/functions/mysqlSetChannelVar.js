...
module.exports = async (d) => {
    ...
    let [varname, value, channelID = d.channel.id, table = d.client.mysql.tables[0],] = data.inside.splits;
    ...
    try {
        await d.client.mysql.set(table, varname?.addBrackets(), channelID, value);
    }
    catch (e) {
